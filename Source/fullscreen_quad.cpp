...
{
	GpuResourceUtils::LoadVertexShader(device, "Data/Shader/fullscreen_quad_vs.cso",nullptr, 0, nullptr, embedded_vertex_shader.ReleaseAndGetAddressOf());
	GpuResourceUtils::LoadPixelShader(device, "Data/Shader/fullscreen_quad_ps.cso", embedded_pixel_shader.ReleaseAndGetAddressOf());
}
